...
<div class="sl-mainpanel">
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
            ...
            @if($order->status == 0)
            <a href="{{URL('/adminPaymentAccept/'.$order->id)}}" class="btn btn-info">Payment Accept</a>
            <a href="{{URL('/adminPaymentCancel/'.$order->id)}}" class="btn btn-danger">Order Cancel</a>
            @elseif($order->status == 1)
            <a href="{{ url('/adminDeleveryProcess/'.$order->id) }}" class="btn btn-info">Process Delevery </a>
            @elseif($order->status == 2)
            <a href="{{ url('/adminDeleveryDone/'.$order->id) }}" class="btn btn-success">Delevery Done </a>
