...
@section('admin_content')
 ...
 <a href="{{ route('all.blogPost')}}" class="btn btn-success btn-sm pull-right"> All Post</a>
       ...
       <form method="post" action="{{ route('insert.blogPost')}}" enctype="multipart/form-data">    
        @csrf
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="post_title_np"  placeholder="Enter Post Title np Nepali">
                </div>
              </div><!-- col-4 -->
       ...
       <select class="form-control select2" data-placeholder="Choose country" name="category_id">
                    ...
                    <option value="{{ $br->id }}">{{ $br->category_name_en }}</option>
                    @endforeach
                  </select>
                </div>
              </div><!-- col-4 -->
