...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <form method="post" action="{{URL::to('/updateProduct/'.$product->id)}} " enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row mg-b-25">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="summernote" name="product_detail">
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <form method="post" action="{{ url('/updateProductPhoto/'.$product->id) }} " enctype="multipart/form-data">
                @csrf
