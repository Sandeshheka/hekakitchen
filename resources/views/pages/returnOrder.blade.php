...
<div class="contact_form">
    <div class="container">
        <div class="row">
                ...
                <table class="table table-response">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td scope="col">
                                @if($row->return_order == 0)
                                <a href="{{url('/requestReturn/'.$row->id)}}" class="btn btn-sm btn-danger" id="return"> Return</a>
                                @elseif($row->return_order == 1)
                                <span class="badge badge-info">Pending</span>
                                @elseif($row->return_order == 2)
                                <span class="badge badge-warning">Success</span>
            ...
            <div class="col-4">
                <div class="card">
                    <img src="{{ asset('frontend/images/kalu.png') }}" class="card-img-top" style="height: 90px; width: 90px; margin-left: 34%;">
                    <div class="card-body">
