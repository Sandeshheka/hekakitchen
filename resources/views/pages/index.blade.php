					...
					<div class="deals_slider_container">
						...
						<div class="owl-carousel owl-theme deals_slider">
							...
							<div class="owl-item deals_item">
								<div class="deals_image"><img src="{{asset($h->image_one)}}" alt=""></div>
								<div class="deals_content">
									<div class="deals_info_line d-flex flex-row justify-content-start">
										<div class="deals_item_category"><a href="#">{{$h->brand_name}}</a>
										</div>
										@if($h->discount_price == NULL)
										@else
										<div class="deals_item_price_a ml-auto">Rs.{{$h->selling_price}}</div>
										@endif

									</div>
									<div class="deals_info_line d-flex flex-row justify-content-start">
										<div class="deals_item_name">{{$h->product_name}}</div>
										@if($h->discount_price == NULL)
										<div class="deals_item_price ml-auto">Rs.{{$h->selling_price}}</div>
										@else

										@endif
										@if($h->discount_price != NULL)
										<div class="deals_item_price ml-auto">Rs.{{$h->discount_price}}</div>
										@endif
									</div>
									<div class="available">
										<div class="available_line d-flex flex-row justify-content-start">
											<div class="available_title">Available: <span>{{$h->product_quantity}}</span></div>
							...
							<div class="featured_slider slider">
								...
								<div class="featured_slider_item">
									...
									<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
										<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{asset($f->image_one)}}" 
										style="height: 120px; width: 140px;" alt=""></div>
										<div class="product_content">
											@if($f->discount_price == Null)

											<div class="product_price discount">Rs.{{$f->selling_price}}</div>
											@else
											<div class="product_price discount">Rs.{{$f->discount_price}}<span>Rs.{{$f->selling_price}}</span></div>

											@endif

											<div class="product_name">
												<div><a href="{{url('productDetails/'.$f->id.'/'.$f->product_name)}}">{{$f->product_name}}</a></div>
											</div>
											<!-- <div class="product_extras">

												<button class="product_cart_button addcart" data-id="{{$f->id}}">
													Add to Cart</button>
                                            </div> -->
                                            <div class="product_extras">

                                            <button id="{{ $f->id }}" class="product_cart_button addcart" data-toggle="modal" data-target="#cartmodal" onclick="productView(this.id)">Add to Cart</button>
													Add to Cart</button>
											</div>
										</div>
										<button class="addwishlist" data-id="{{$f->id}}">
										...
										<ul class="product_marks">
											@if($f->discount_price == NULL)
											<li class="product_mark product_discount" style="background: orange;">New</li>

											@else
											<li class="product_mark product_discount">
												@php
												$amount= $f->selling_price - $f->discount_price;
												$discount = $amount/$f->selling_price*100;
												@endphp
						...
						<div class="row fill_height">
							<div class="col-lg-4 col-md-6 fill_height">
								<div class="banner_2_content">
									<div class="banner_2_category">
										<h4>{{$m->category_name}}</h4>
									</div>
									<div class="banner_2_title">{{$m->product_name}}</div>
									<div class="banner_2_text">
										<h4>{{$m->brand_name}}</h4> <br>
										<h2>Rs.{{$m->selling_price}}</h2>
									</div>
							...
							<div class="col-lg-8 col-md-6 fill_height">
								<div class="banner_2_image_container">
									<div class="banner_2_image"><img src="{{asset($m->image_two)}}" style="height: 300px; width: 250px;" alt=""></div>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="row">
			...
			<div class="col-lg-4 advert_col">
				...
				<div class="advert d-flex flex-row align-items-center justify-content-start">
					...
					<div class="ml-auto">
						<div class="advert_image"><img src="{{asset('frontend/images/hello.png')}}" alt=""></div>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 advert_col">
				...
				<div class="advert d-flex flex-row align-items-center justify-content-start">
					...
					<div class="ml-auto">
						<div class="advert_image"><img src="{{asset('frontend/images/hello1.png')}}" alt=""></div>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 advert_col">
				...
				<div class="advert d-flex flex-row align-items-center justify-content-start">
					...
					<div class="ml-auto">
						<div class="advert_image"><img src="{{asset('frontend/images/hello2.png')}}" alt=""></div>
					</div>
				</div>
			</div>
...
<div class="trends">
	<div class="trends_background" style="background-image:url( {{ asset('/frontend/images/banner_background.jpg')}})"></div>
		...
		<div class="row">
			...
			<div class="col-lg-3">
				<div class="trends_container">
					<h2 class="trends_title">Shop By Brands</h2>
				...
				@foreach($brands as $brand)
						...
						<div class="owl-item">
							<div class="trends_item is_new">
								<div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{asset($brand->brand_logo)}}" alt=""></div>
								<div class="trends_content">
									<div class="trends_category"><a href="#">{{$brand->brand_name}}</a></div>
			...
			<div class="col">
				<div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
					...
					<div class="newsletter_content clearfix">
						<form action="{{route('newslater.store')}}" method="post" class="newsletter_form">
							@csrf
