						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								...
								@foreach($category as $cat)
									<li class="hassubs">
										<a href="{{URL::to('/allCategory/'.$cat->id)}}">{{$cat->category_name}}<i class="fas fa-chevron-right"></i></a>
										<ul>
											@php
											...
											<li class="hassubs">
												<a href="{{URL::to('/products/'.$sub->id)}}">{{$sub->subcategory_name}}<i class="fas fa-chevron-right"></i></a>
											</li>
											@endforeach
